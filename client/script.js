...
/*
    ...
    and its text color to white (you can use the .style object or 
        create a CSS class and use classList.add)
...
// CODE HERE
function changeColorsBack(event) {
...
/*
    ...
    Use axios inside the ohMy function to make a GET 
    request to 'http://localhost:3000/animals' 
...
/*
    ...
    'http://localhost:3000/repeat/{SOMEPARAM}', but with a string 
    ...
    which will take in a callback -- the callback function should print the 
    response.data.
...
/*
    ...
    'http://localhost:3000/query-test', with a query of your choice on the end!
...
// CODE HERE
const getRequest = () => {
    axios.get('http://localhost:3000/query-test/?name=Rodney')
    .then(res => {
        console.log(res.data)
    })
} 
